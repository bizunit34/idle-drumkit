...
export const defaultDrumPieces: DrumPiece[] = [
  {
    ...
    color: '#FACC15',
    imageAssetKey: 'crash',
    defaultVisualSize: { width: 0.24, height: 0.17 },
  ...
  },
  {
    ...
    size: { width: 0.23, height: 0.18 },
    shape: 'oval',
    color: '#22D3EE',
    imageAssetKey: 'hiHat',
    defaultVisualSize: { width: 0.28, height: 0.21 },
    imageAspectRatio: 1.35,
    hitBoxShape: 'oval',
    zIndex: 4,
  ...
  },
  {
    ...
    size: { width: 0.24, height: 0.22 },
    shape: 'circle',
    color: '#FB923C',
    imageAssetKey: 'snare',
    defaultVisualSize: { width: 0.28, height: 0.28 },
    imageAspectRatio: 1,
    hitBoxShape: 'circle',
    zIndex: 6,
  ...
  },
  {
    ...
    size: { width: 0.29, height: 0.29 },
    shape: 'circle',
    color: '#E5E7EB',
    imageAssetKey: 'kick',
    defaultVisualSize: { width: 0.34, height: 0.34 },
    imageAspectRatio: 1,
    hitBoxShape: 'circle',
    zIndex: 2,
  ...
  },
  {
    ...
    size: { width: 0.22, height: 0.21 },
    shape: 'circle',
    color: '#60A5FA',
    imageAssetKey: 'floorTom',
    defaultVisualSize: { width: 0.25, height: 0.25 },
    imageAspectRatio: 1,
    hitBoxShape: 'circle',
    zIndex: 4,
  ...
  },
  {
    ...
    size: { width: 0.21, height: 0.16 },
    shape: 'oval',
    color: '#FCD34D',
    imageAssetKey: 'ride',
    defaultVisualSize: { width: 0.25, height: 0.18 },
    imageAspectRatio: 1.35,
    hitBoxShape: 'oval',
    zIndex: 1,
